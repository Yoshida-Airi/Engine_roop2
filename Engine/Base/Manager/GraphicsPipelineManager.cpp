...
GraphicsPipelineManager::PSOData GraphicsPipelineManager::CreateCopyImage(const std::wstring& filePath)
{
	PSOData psoData;
	...
	psoData = CreateCommonPSO(filePath, rootParameters, 1, depthStencilDesc, inputLayoutDesc);


	return psoData;
}

GraphicsPipelineManager::PSOData GraphicsPipelineManager::CreateGrayScale(const std::wstring& filePath)
{
	PSOData psoData;
...
GraphicsPipelineManager::PSOData GraphicsPipelineManager::CreateCommonPostEffectPSO(const std::wstring& filePath, D3D12_ROOT_PARAMETER* rootParameters, int numRootParameters, D3D12_DEPTH_STENCIL_DESC depthStencilDesc, D3D12_INPUT_LAYOUT_DESC inputLayoutDesc)
{
	PSOData psoData;
